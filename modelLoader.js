...
class ModelLoader {
  ...
  setMeshCollisionSystem(system) {
  meshCollisionSystem = system;
}
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('grave', this.models.grave);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('altar', this.models.altar);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('paper', this.models.paper);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('key', this.models.key);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('door', this.models.door);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('crow', this.models.crow);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('desk', this.models.desk);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('desk2', this.models.desk2);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('book1', this.models.book1);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('book2', this.models.book2);
            }, 100);
          }
    ...
    return new Promise((resolve) => {
      this.loadModelOptimized(
        ...
        (gltf) => {
          ...
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('scroll', this.models.scroll);
            }, 100);
          }
...
//////////// FOR ACTUAL PORTAL USE, JUST PUT THIS HERE!!    externalUrl: 'https://www.example.com/'
          ...
          // Register collision for this specific portal
          if (meshCollisionSystem) {
            setTimeout(() => {
              meshCollisionSystem.registerModelCollision('portal_main', portalModel);
            }, 100);
          }
